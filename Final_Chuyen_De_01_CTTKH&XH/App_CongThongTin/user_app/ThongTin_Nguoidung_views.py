...
def viewlist(request):
	...
	baiviet1 = tbltinBai.objects.all().filter(DanhMuc__TenDanhMuc="Tin KH&CN Bình Dương")
	baiviet2 = tbltinBai.objects.all().filter(DanhMuc__TenDanhMuc="Kết quả nghiên cứu trong và ngoài nước")
	baiviet3 = tbltinBai.objects.all().filter(DanhMuc__TenDanhMuc="Tin KH&CN trong nước")
	baiviet4 = tbltinBai.objects.all().filter(DanhMuc__TenDanhMuc="Tin KH&CN Thế giới")
